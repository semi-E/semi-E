...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    	<div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
      		<a class="navbar-brand brand-logo mr-5" href="/lms/student/main.jsp"><img src="/lms/upload/mm.svg" class="mr-2" alt="logo"/></a>
       	<a class="navbar-brand brand-logo-mini" href="index.html"><img src="/lms/upload/mm.svg" alt="logo"/></a>
     	</div>
     	<div class="navbar-menu-wrapper d-flex align-items-center">
     		<ul class="navbar-nav me-auto mb-2 mb-lg-0">
        	<li class="nav-item">
          		<a class="nav-link" href="/lms/student/myPage.jsp" role="button">
            		마이페이지
          		</a>
        	</li>
        	<li class="nav-item dropdown">
          		<a class="nav-link dropdown-toggle" href="/lms/student/class/myClassList.jsp" role="button" data-toggle="dropdown" aria-expanded="false">
            		강의
          		</a>
          		<ul class="dropdown-menu" style="position:absolute;">
	            	<li><a class="dropdown-item" href="/lms/student/class/myClassList.jsp">내 강의 목록</a></li>
	            	<li><a class="dropdown-item" href="/lms/student/class/schedule.jsp">시간표</a></li>
	            	<li><a class="dropdown-item" href="/lms/student/class/classList.jsp">강의 목록</a></li>
	            	<li><a class="dropdown-item" href="/lms/student/class/subjectList.jsp">과목 목록</a></li>
	          	</ul>
          	</li>
        	<li class="nav-item dropdown">
          		<a class="nav-link" href="/lms/student/classBoard/myClassBoardList.jsp" role="button">
            		강의 게시판
          		</a>
          	</li>
        	<li class="nav-item dropdown">
          		<a class="nav-link" href="/lms/student/classApply/classApplyList.jsp" role="button">
            		수강신청
          		</a>
          	</li>
        	<li class="nav-item">
          		<a class="nav-link" href="/lms/student/notice/noticeList.jsp" role="button">
            		공지사항
          		</a>
          	</li>
     		</ul>
