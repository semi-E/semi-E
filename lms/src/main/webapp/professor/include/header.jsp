...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    	<div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
      		<a class="navbar-brand brand-logo mr-5" href="/lms/professor/main.jsp"><img src="/lms/upload/mm.svg" class="mr-2" alt="logo"/></a>
     	...
     	<div class="navbar-menu-wrapper d-flex align-items-center">
        	...
        	<li class="nav-item dropdown">
          		<a class="nav-link dropdown-toggle" href="/lms/professor/class/myClassList.jsp" role="button" data-toggle="dropdown" aria-expanded="false">
            		강의
          		</a>
