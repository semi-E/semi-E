            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="class">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="/lms/professor/class/myClassList.jsp"
                      >내 강의 목록</a
                    >
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="/lms/professor/class/addClassOpenApplyForm.jsp"
                      >강의 개설 신청</a
                    >
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="/lms/professor/class/classList.jsp"
                      >강의 목록</a
                    >
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="/lms/professor/class/subjectList.jsp"
                      >과목 목록</a
                    >
                  </li>
                </ul>
